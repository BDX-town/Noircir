                        ...
                        <Block variant='interactive' className='flex flex-col md:flex-row p-0 overflow-hidden bg-additional-primary min-h-[130px]'>
                            ...
                            <article className='flex flex-col p-3 grow'>
                                <div className='flex'>
                                    ...
                                    <a onClick={(e) => e.stopPropagation()} className='align-middle text-brand-primary-dark' href={buildLink(import.meta.env.VITE_SERVER, client as Webdav, post)} target="_blank"><T>read</T><IconExternalLink className='ml-2 align-middle' size={16} /></a>
                                </div>
